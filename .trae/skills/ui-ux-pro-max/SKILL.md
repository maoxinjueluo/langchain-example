---
name: "ui-ux-pro-max"
description: "UI/UX design intelligence with searchable database. Invoke when user asks for UI/UX design, landing pages, dashboards, or design system generation."
---
...
```bash
python3 .trae/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack react-native
```
